        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-16">
            <div className="space-y-8">
              ...
              <Link href={`/contact?ref=${encodeURIComponent('https://nabhira.com/industries/healthcare-pharma')}&title=${encodeURIComponent('Healthcare & Life Sciences')}&category=Industries`} className="inline-flex items-center gap-2 text-[#f99d1c] font-medium hover:gap-4 transition-all">
